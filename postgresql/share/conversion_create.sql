...
CREATE OR REPLACE FUNCTION ascii_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/ascii_and_mic', 'ascii_to_mic' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION mic_to_ascii (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/ascii_and_mic', 'mic_to_ascii' LANGUAGE C STRICT;
...
-- KOI8R --> MULE_INTERNAL
CREATE OR REPLACE FUNCTION koi8r_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'koi8r_to_mic' LANGUAGE C STRICT;
...
-- MULE_INTERNAL --> KOI8R
CREATE OR REPLACE FUNCTION mic_to_koi8r (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'mic_to_koi8r' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION iso_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'iso_to_mic' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION mic_to_iso (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'mic_to_iso' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION win1251_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'win1251_to_mic' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION mic_to_win1251 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'mic_to_win1251' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION win866_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'win866_to_mic' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION mic_to_win866 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'mic_to_win866' LANGUAGE C STRICT;
...
-- KOI8R --> WIN1251
CREATE OR REPLACE FUNCTION koi8r_to_win1251 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'koi8r_to_win1251' LANGUAGE C STRICT;
...
-- WIN1251 --> KOI8R
CREATE OR REPLACE FUNCTION win1251_to_koi8r (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'win1251_to_koi8r' LANGUAGE C STRICT;
...
-- KOI8R --> WIN866
CREATE OR REPLACE FUNCTION koi8r_to_win866 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'koi8r_to_win866' LANGUAGE C STRICT;
...
-- WIN866 --> KOI8R
CREATE OR REPLACE FUNCTION win866_to_koi8r (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'win866_to_koi8r' LANGUAGE C STRICT;
...
-- WIN866 --> WIN1251
CREATE OR REPLACE FUNCTION win866_to_win1251 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'win866_to_win1251' LANGUAGE C STRICT;
...
-- WIN1251 --> WIN866
CREATE OR REPLACE FUNCTION win1251_to_win866 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'win1251_to_win866' LANGUAGE C STRICT;
...
-- ISO-8859-5 --> KOI8R
CREATE OR REPLACE FUNCTION iso_to_koi8r (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'iso_to_koi8r' LANGUAGE C STRICT;
...
-- KOI8R --> ISO-8859-5
CREATE OR REPLACE FUNCTION koi8r_to_iso (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'koi8r_to_iso' LANGUAGE C STRICT;
...
-- ISO-8859-5 --> WIN1251
CREATE OR REPLACE FUNCTION iso_to_win1251 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'iso_to_win1251' LANGUAGE C STRICT;
...
-- WIN1251 --> ISO-8859-5
CREATE OR REPLACE FUNCTION win1251_to_iso (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'win1251_to_iso' LANGUAGE C STRICT;
...
-- ISO-8859-5 --> WIN866
CREATE OR REPLACE FUNCTION iso_to_win866 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'iso_to_win866' LANGUAGE C STRICT;
...
-- WIN866 --> ISO-8859-5
CREATE OR REPLACE FUNCTION win866_to_iso (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/cyrillic_and_mic', 'win866_to_iso' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION euc_cn_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_cn_and_mic', 'euc_cn_to_mic' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION mic_to_euc_cn (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_cn_and_mic', 'mic_to_euc_cn' LANGUAGE C STRICT;
...
-- EUC_JP --> SJIS
CREATE OR REPLACE FUNCTION euc_jp_to_sjis (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_jp_and_sjis', 'euc_jp_to_sjis' LANGUAGE C STRICT;
...
-- SJIS --> EUC_JP
CREATE OR REPLACE FUNCTION sjis_to_euc_jp (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_jp_and_sjis', 'sjis_to_euc_jp' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION euc_jp_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_jp_and_sjis', 'euc_jp_to_mic' LANGUAGE C STRICT;
...
-- SJIS --> MULE_INTERNAL
CREATE OR REPLACE FUNCTION sjis_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_jp_and_sjis', 'sjis_to_mic' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION mic_to_euc_jp (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_jp_and_sjis', 'mic_to_euc_jp' LANGUAGE C STRICT;
...
-- MULE_INTERNAL --> SJIS
CREATE OR REPLACE FUNCTION mic_to_sjis (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_jp_and_sjis', 'mic_to_sjis' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION euc_kr_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_kr_and_mic', 'euc_kr_to_mic' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION mic_to_euc_kr (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_kr_and_mic', 'mic_to_euc_kr' LANGUAGE C STRICT;
...
-- EUC_TW --> BIG5
CREATE OR REPLACE FUNCTION euc_tw_to_big5 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_tw_and_big5', 'euc_tw_to_big5' LANGUAGE C STRICT;
...
-- BIG5 --> EUC_TW
CREATE OR REPLACE FUNCTION big5_to_euc_tw (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_tw_and_big5', 'big5_to_euc_tw' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION euc_tw_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_tw_and_big5', 'euc_tw_to_mic' LANGUAGE C STRICT;
...
-- BIG5 --> MULE_INTERNAL
CREATE OR REPLACE FUNCTION big5_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_tw_and_big5', 'big5_to_mic' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION mic_to_euc_tw (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_tw_and_big5', 'mic_to_euc_tw' LANGUAGE C STRICT;
...
-- MULE_INTERNAL --> BIG5
CREATE OR REPLACE FUNCTION mic_to_big5 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc_tw_and_big5', 'mic_to_big5' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION latin2_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/latin2_and_win1250', 'latin2_to_mic' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION mic_to_latin2 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/latin2_and_win1250', 'mic_to_latin2' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION win1250_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/latin2_and_win1250', 'win1250_to_mic' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION mic_to_win1250 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/latin2_and_win1250', 'mic_to_win1250' LANGUAGE C STRICT;
...
-- LATIN2 --> WIN1250
CREATE OR REPLACE FUNCTION latin2_to_win1250 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/latin2_and_win1250', 'latin2_to_win1250' LANGUAGE C STRICT;
...
-- WIN1250 --> LATIN2
CREATE OR REPLACE FUNCTION win1250_to_latin2 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/latin2_and_win1250', 'win1250_to_latin2' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION latin1_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/latin_and_mic', 'latin1_to_mic' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION mic_to_latin1 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/latin_and_mic', 'mic_to_latin1' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION latin3_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/latin_and_mic', 'latin3_to_mic' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION mic_to_latin3 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/latin_and_mic', 'mic_to_latin3' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION latin4_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/latin_and_mic', 'latin4_to_mic' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION mic_to_latin4 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/latin_and_mic', 'mic_to_latin4' LANGUAGE C STRICT;
...
-- SQL_ASCII --> UTF8
CREATE OR REPLACE FUNCTION ascii_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_ascii', 'ascii_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> SQL_ASCII
CREATE OR REPLACE FUNCTION utf8_to_ascii (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_ascii', 'utf8_to_ascii' LANGUAGE C STRICT;
...
-- BIG5 --> UTF8
CREATE OR REPLACE FUNCTION big5_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_big5', 'big5_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> BIG5
CREATE OR REPLACE FUNCTION utf8_to_big5 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_big5', 'utf8_to_big5' LANGUAGE C STRICT;
...
-- UTF8 --> KOI8R
CREATE OR REPLACE FUNCTION utf8_to_koi8r (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_cyrillic', 'utf8_to_koi8r' LANGUAGE C STRICT;
...
-- KOI8R --> UTF8
CREATE OR REPLACE FUNCTION koi8r_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_cyrillic', 'koi8r_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> KOI8U
CREATE OR REPLACE FUNCTION utf8_to_koi8u (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_cyrillic', 'utf8_to_koi8u' LANGUAGE C STRICT;
...
-- KOI8U --> UTF8
CREATE OR REPLACE FUNCTION koi8u_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_cyrillic', 'koi8u_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> WIN866
CREATE OR REPLACE FUNCTION utf8_to_win (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_win', 'utf8_to_win' LANGUAGE C STRICT;
...
-- WIN866 --> UTF8
CREATE OR REPLACE FUNCTION win_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_win', 'win_to_utf8' LANGUAGE C STRICT;
...
-- EUC_CN --> UTF8
CREATE OR REPLACE FUNCTION euc_cn_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_euc_cn', 'euc_cn_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> EUC_CN
CREATE OR REPLACE FUNCTION utf8_to_euc_cn (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_euc_cn', 'utf8_to_euc_cn' LANGUAGE C STRICT;
...
-- EUC_JP --> UTF8
CREATE OR REPLACE FUNCTION euc_jp_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_euc_jp', 'euc_jp_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> EUC_JP
CREATE OR REPLACE FUNCTION utf8_to_euc_jp (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_euc_jp', 'utf8_to_euc_jp' LANGUAGE C STRICT;
...
-- EUC_KR --> UTF8
CREATE OR REPLACE FUNCTION euc_kr_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_euc_kr', 'euc_kr_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> EUC_KR
CREATE OR REPLACE FUNCTION utf8_to_euc_kr (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_euc_kr', 'utf8_to_euc_kr' LANGUAGE C STRICT;
...
-- EUC_TW --> UTF8
CREATE OR REPLACE FUNCTION euc_tw_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_euc_tw', 'euc_tw_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> EUC_TW
CREATE OR REPLACE FUNCTION utf8_to_euc_tw (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_euc_tw', 'utf8_to_euc_tw' LANGUAGE C STRICT;
...
-- GB18030 --> UTF8
CREATE OR REPLACE FUNCTION gb18030_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_gb18030', 'gb18030_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> GB18030
CREATE OR REPLACE FUNCTION utf8_to_gb18030 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_gb18030', 'utf8_to_gb18030' LANGUAGE C STRICT;
...
-- GBK --> UTF8
CREATE OR REPLACE FUNCTION gbk_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_gbk', 'gbk_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> GBK
CREATE OR REPLACE FUNCTION utf8_to_gbk (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_gbk', 'utf8_to_gbk' LANGUAGE C STRICT;
...
-- UTF8 --> LATIN2
CREATE OR REPLACE FUNCTION utf8_to_iso8859 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_iso8859', 'utf8_to_iso8859' LANGUAGE C STRICT;
...
-- LATIN2 --> UTF8
CREATE OR REPLACE FUNCTION iso8859_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_iso8859', 'iso8859_to_utf8' LANGUAGE C STRICT;
...
-- LATIN1 --> UTF8
CREATE OR REPLACE FUNCTION iso8859_1_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_iso8859_1', 'iso8859_1_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> LATIN1
CREATE OR REPLACE FUNCTION utf8_to_iso8859_1 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_iso8859_1', 'utf8_to_iso8859_1' LANGUAGE C STRICT;
...
-- JOHAB --> UTF8
CREATE OR REPLACE FUNCTION johab_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_johab', 'johab_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> JOHAB
CREATE OR REPLACE FUNCTION utf8_to_johab (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_johab', 'utf8_to_johab' LANGUAGE C STRICT;
...
-- SJIS --> UTF8
CREATE OR REPLACE FUNCTION sjis_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_sjis', 'sjis_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> SJIS
CREATE OR REPLACE FUNCTION utf8_to_sjis (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_sjis', 'utf8_to_sjis' LANGUAGE C STRICT;
...
-- UHC --> UTF8
CREATE OR REPLACE FUNCTION uhc_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_uhc', 'uhc_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> UHC
CREATE OR REPLACE FUNCTION utf8_to_uhc (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_uhc', 'utf8_to_uhc' LANGUAGE C STRICT;
...
-- EUC_JIS_2004 --> UTF8
CREATE OR REPLACE FUNCTION euc_jis_2004_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_euc2004', 'euc_jis_2004_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> EUC_JIS_2004
CREATE OR REPLACE FUNCTION utf8_to_euc_jis_2004 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_euc2004', 'utf8_to_euc_jis_2004' LANGUAGE C STRICT;
...
-- SHIFT_JIS_2004 --> UTF8
CREATE OR REPLACE FUNCTION shift_jis_2004_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_sjis2004', 'shift_jis_2004_to_utf8' LANGUAGE C STRICT;
...
-- UTF8 --> SHIFT_JIS_2004
CREATE OR REPLACE FUNCTION utf8_to_shift_jis_2004 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/utf8_and_sjis2004', 'utf8_to_shift_jis_2004' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION euc_jis_2004_to_shift_jis_2004 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc2004_sjis2004', 'euc_jis_2004_to_shift_jis_2004' LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION shift_jis_2004_to_euc_jis_2004 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '/Applications/jasperreports-server-6.0.1/postgresql/lib/euc2004_sjis2004', 'shift_jis_2004_to_euc_jis_2004' LANGUAGE C STRICT;
